...
{
    /// <summary>Crewed command pod - Mk1, Mk1-3, etc.</summary>
    public sealed class CommandPodArchetype : PartArchetypeBase
    {
        /// <inheritdoc />
        public override string Category => "Pods";
        /// <inheritdoc />
        public override string Family => "0000-Pod";
        /// <inheritdoc />
        public override string DisplayName => "Command pod";
        /// <inheritdoc />
        public override string Description => "Crewed pod with reaction wheel and built-in EC.";
        /// <inheritdoc />
        ...
        public override void SeedDefaults(CorePartData part, BucketResolution bucket)
        {
            ...
            Data_ScienceExperiment sci = FindModuleData<Data_ScienceExperiment>(part);
            if (sci != null)
            {
                sci.Experiments ??= new List<ExperimentConfiguration>();
                SeedScienceExperimentsFromBucket(sci, source);
            }
        }
    }
}
