...
{
    /// <summary>Mountable light.</summary>
    public sealed class LightArchetype : PartArchetypeBase
    {
        public override string Category => "Utility";
        public override string Family => "0540-Light";
        public override string DisplayName => "Light";
        public override string Description => "Toggleable light for illumination.";
