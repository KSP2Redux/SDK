...
{
    [CustomEditor(typeof(ThrottleParticleSystemData))]
    public class ThrottleParticleSystemDataEditor : UnityEditor.Editor
    {
        ...
        {
            var particleData = (ThrottleParticleSystemData)target;
            var manager = particleData.GetComponentInParent<ThrottleVFXManager>();
