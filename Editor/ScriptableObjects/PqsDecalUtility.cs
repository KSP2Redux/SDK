...
namespace Ksp2UnityTools.Editor.ScriptableObjects
{
    ...
    {
        [Header("Decals")] [Tooltip("A list of decal instances")]
        public List<PQSDecal> decals;

        [Header("Texture Arrays")] [Tooltip("The diffuse textures for decals")]
        ...
        [Header("Maps")] [Tooltip("A R16 texture containing the height data")]
