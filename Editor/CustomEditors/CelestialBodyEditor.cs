...
namespace Ksp2UnityTools.Editor.CustomEditors
{
    ...
    public class CelestialBodyEditor : UnityEditor.Editor
    {
        ...
        private static PersistentDictionary JsonPaths =>
            _jsonPaths ??= KSP2UnityToolsManager.GetDictionary("JsonPaths");
        ...
        public override void OnInspectorGUI()
        {
            ...
            string jsonPath = JsonPaths.TryGetValue(TargetObject.name, out string newJsonPath)
                ? newJsonPath
                : "%NAME%.json";
